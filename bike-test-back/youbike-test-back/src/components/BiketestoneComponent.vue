<template>
  ...
  >
    ...
    <n-form-item label="車柱" path="modelRef.testtable['車柱']">
      <n-checkbox-group v-model:value="modelRef.testtable['車柱']['ischeck']">
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['車柱'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item
      label="停車柱貼紙／基板宣導貼紙"
      path="modelRef.testtable['停車柱貼紙／基板宣導貼紙']"
    >
      <n-checkbox-group
        v-model:value="
          modelRef.testtable['停車柱貼紙／基板宣導貼紙']['ischeck']
        "
      >
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['停車柱貼紙／基板宣導貼紙'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item label="座墊高低調整" path="modelRef.testtable['座墊高低調整']">
      <n-checkbox-group
        v-model:value="modelRef.testtable['座墊高低調整']['ischeck']"
      >
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['座墊高低調整'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
...
function creatFrom() {
  ...
  modelRef.value["city"] = station_name.split("-")[1]
