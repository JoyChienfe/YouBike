<template>
  ...
  >
    ...
    <n-form-item path="可用電量" label="可用電量">
      <n-input v-model:value="modelRef.testtable.canusec" />
    </n-form-item>
    <n-form-item label="電量" path="modelRef.testtable['電量']">
      <n-checkbox-group v-model:value="modelRef.testtable['電量']['ischeck']">
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['電量'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item
      label="前／後燈(行進車輪轉動中)"
      path="modelRef.testtable['前／後燈(行進車輪轉動中)']"
    >
      <n-checkbox-group
        v-model:value="
          modelRef.testtable['前／後燈(行進車輪轉動中)']['ischeck']
        "
      >
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['前／後燈(行進車輪轉動中)'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item
      label="前／後燈(暫停車輪靜止中)"
      path="modelRef.testtable['前／後燈(暫停車輪靜止中)']"
    >
      <n-checkbox-group
        v-model:value="
          modelRef.testtable['前／後燈(暫停車輪靜止中)']['ischeck']
        "
      >
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['前／後燈(暫停車輪靜止中)'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item label="費率貼紙" path="modelRef.testtable['費率貼紙']">
      <n-checkbox-group
        v-model:value="modelRef.testtable['費率貼紙']['ischeck']"
      >
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['費率貼紙'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item label="作動" path="modelRef.testtable['作動']">
      <n-checkbox-group v-model:value="modelRef.testtable['作動']['ischeck']">
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['作動'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
    ...
    <n-form-item label="車速" path="modelRef.testtable['車速']">
      <n-checkbox-group v-model:value="modelRef.testtable['車速']['ischeck']">
        <n-space>
          <n-checkbox
            :value="i"
            v-for="i in modelRef.testtable['車速'].value"
            :key="i"
          >
            {{ i }}
          </n-checkbox>
